...
export const registerUser = async (req, res) => {
     ...
     try {
          ...
          const defaultLists = [
               { name: 'read', userId: user._id, visibility: 'private', books: [] },
               { name: 'to read', userId: user._id, visibility: 'private', books: [] },
               { name: 'reading', userId: user._id, visibility: 'private', books: [] },
               { name: 'favourites', userId: user._id, visibility: 'private', books: [] }
          ];
